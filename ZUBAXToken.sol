...
// ZabuToken with Governance.
contract ZABUv2Token is ERC20("ZUBAX Token", "ZUBAX"), Ownable, Authorizable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "ZABU::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "ZABU::delegateBySig: invalid nonce");
        require(now <= expiry, "ZABU::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "ZABU::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "ZABU::_writeCheckpoint: block number exceeds 32 bits");
